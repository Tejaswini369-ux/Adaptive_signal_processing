...
const Theory = () => {
  return (
    <div className='leading-loose'>
      <p className='text-lg font-semibold underline pb-2'>Autoregressive Model </p>
      <p >
      ...
      <p className='text-lg font-semibold underline pb-2'>Basic concept of Autoregressive Models </p>
