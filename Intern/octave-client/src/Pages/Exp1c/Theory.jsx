...
const Theory = () => {
  return (
    <div className='leading-loose '>
      <p className='text-lg font-semibold underline pb-2'>Stochastic Process Definition </p>
      ...
      <p className='text-lg font-semibold underline pb-2'>Types of Stochastic Processes </p>
      ...
      <p className='text-lg font-semibold underline pb-2'>Stationary Random Processes </p>
      ...
      <p className='text-lg font-semibold underline pb-2'>Non-Stationary processes </p>
